...
fun DeleteUserSection(
    ...
    LaunchedEffect(currentUserId, refreshTrigger, deletedUserId) {
        isLoading = true
        selectedUser = null

        try {
            val response = ApiClient.api.getAdminBuildingUsers(currentUserId)
                ...
                users = body.users
                    ...
                    .let { list ->
                        if (deletedUserId != null) {
                            list.filterNot { it.id == deletedUserId }
                        } else {
                            list
                        }
                    }
